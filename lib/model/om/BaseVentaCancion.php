...
/**
 * Base class that represents a row from the 'venta_cancion' table.
 *
 * 
 *
 ...
 */
abstract class BaseVentaCancion extends BaseObject  implements Persistent {
	 ...
	 * @return     VentaCancion The current object (for fluent API support)
	 */
	public function setCancion($v)
	{
		...
		if ($this->cancion !== $v) {
			$this->cancion = $v;
			$this->modifiedColumns[] = VentaCancionPeer::CANCION;
		}
	...
	public function setVenta($v)
	{
		...
		if ($this->venta !== $v) {
			$this->venta = $v;
			$this->modifiedColumns[] = VentaCancionPeer::VENTA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = VentaCancionPeer::NUM_COLUMNS - VentaCancionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating VentaCancion object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = VentaCancionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseVentaCancion:delete:pre') as $callable)
			{
			...
			if ($ret) {
				VentaCancionPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseVentaCancion:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseVentaCancion:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseVentaCancion:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				VentaCancionPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = VentaCancionPeer::doInsert($this, $con);
					...
					$affectedRows += VentaCancionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = VentaCancionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = VentaCancionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = VentaCancionPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VentaCancionPeer::CANCION)) $criteria->add(VentaCancionPeer::CANCION, $this->cancion);
		if ($this->isColumnModified(VentaCancionPeer::VENTA)) $criteria->add(VentaCancionPeer::VENTA, $this->venta);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(VentaCancionPeer::CANCION, $this->cancion);
		$criteria->add(VentaCancionPeer::VENTA, $this->venta);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of VentaCancion (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     VentaCancion Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     VentaCancionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new VentaCancionPeer();
		}
		return self::$peer;
	}
	...
	public function getCancionRelatedByCancion(PropelPDO $con = null)
	{
		if ($this->aCancionRelatedByCancion === null && ($this->cancion !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCancionRelatedByCancion->addVentaCancions($this);
			 */
		}
	...
	public function getVentaRelatedByVenta(PropelPDO $con = null)
	{
		if ($this->aVentaRelatedByVenta === null && ($this->venta !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aVentaRelatedByVenta->addVentaCancions($this);
			 */
		}
	 ...
	 * Otherwise if this VentaCancion has previously been saved, it will retrieve
	 * related ProgramacionCancions from storage. If this VentaCancion is new, it will return
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseVentaCancion:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseVentaCancion::%s', $method));
	  }
