...
abstract class BaseMensaje extends BaseObject  implements Persistent {
	...
	public function setCodigo($v)
	{
		...
		if ($this->codigo !== $v) {
			$this->codigo = $v;
			$this->modifiedColumns[] = MensajePeer::CODIGO;
		}
	...
	public function setUsuario($v)
	{
		...
		if ($this->usuario !== $v) {
			$this->usuario = $v;
			$this->modifiedColumns[] = MensajePeer::USUARIO;
		}
	...
	public function setAsunto($v)
	{
		...
		if ($this->asunto !== $v) {
			$this->asunto = $v;
			$this->modifiedColumns[] = MensajePeer::ASUNTO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->asunto = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = MensajePeer::NUM_COLUMNS - MensajePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseMensaje:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseMensaje:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseMensaje:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseMensaje:save:post') as $callable)
				{
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setAsunto($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MensajePeer::CODIGO)) $criteria->add(MensajePeer::CODIGO, $this->codigo);
		if ($this->isColumnModified(MensajePeer::USUARIO)) $criteria->add(MensajePeer::USUARIO, $this->usuario);
		if ($this->isColumnModified(MensajePeer::ASUNTO)) $criteria->add(MensajePeer::ASUNTO, $this->asunto);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(MensajePeer::CODIGO, $this->codigo);
	...
	public function getUsuarioRelatedByUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByUsuario === null && ($this->usuario !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUsuarioRelatedByUsuario->addMensajes($this);
			 */
		}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseMensaje:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseMensaje::%s', $method));
	  }
