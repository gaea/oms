...
abstract class BaseProgramacionCancion extends BaseObject  implements Persistent {
	...
	public function setCancion($v)
	{
		...
		if ($this->aVentaCancion !== null && $this->aVentaCancion->getCancion() !== $v) {
			$this->aVentaCancion = null;
		}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aVentaCancion !== null && $this->cancion !== $this->aVentaCancion->getCancion()) {
			$this->aVentaCancion = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aVentaCancion !== null) {
				if ($this->aVentaCancion->isModified() || $this->aVentaCancion->isNew()) {
					$affectedRows += $this->aVentaCancion->save($con);
				}
				$this->setVentaCancion($this->aVentaCancion);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aVentaCancion !== null) {
				if (!$this->aVentaCancion->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aVentaCancion->getValidationFailures());
				}
			}
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ProgramacionCancionPeer::FIN, $this->fin);
	...
	/**
	 * Declares an association between this object and a VentaCancion object.
	 *
	 * @param      VentaCancion $v
	 * @return     ProgramacionCancion The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setVentaCancion(VentaCancion $v = null)
	{
		if ($v === null) {
			$this->setCancion(NULL);
		} else {
			$this->setCancion($v->getCancion());
		}

		$this->aVentaCancion = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the VentaCancion object, it will not be re-added.
		if ($v !== null) {
	...
	/**
	 * Get the associated VentaCancion object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     VentaCancion The associated VentaCancion object.
	 * @throws     PropelException
	 */
	public function getVentaCancion(PropelPDO $con = null)
	{
		if ($this->aVentaCancion === null && ($this->cancion !== null)) {
			$this->aVentaCancion = VentaCancionPeer::retrieveByPk($this->cancion);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aVentaCancion->addProgramacionCancions($this);
			 */
		}
		return $this->aVentaCancion;
	}
