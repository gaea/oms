...
abstract class BaseProgramacionCunaPeer {
	...
	/**
	 * Returns the number of rows matching criteria, joining the related VentaCuniaComercial table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinVentaCuniaComercial(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ProgramacionCunaPeer::VENTA, VentaCuniaComercialPeer::VENTA, $join_behavior);
	...
	/**
	 * Selects a collection of ProgramacionCuna objects pre-filled with their VentaCuniaComercial objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of ProgramacionCuna objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinVentaCuniaComercial(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		ProgramacionCunaPeer::addSelectColumns($criteria);
		$startcol = (ProgramacionCunaPeer::NUM_COLUMNS - ProgramacionCunaPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = ProgramacionCunaPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = ProgramacionCunaPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				ProgramacionCunaPeer::addInstanceToPool($obj1, $key1);
			} // if $obj1 already loaded

			$key2 = VentaCuniaComercialPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = VentaCuniaComercialPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					VentaCuniaComercialPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
				
				// Add the $obj1 (ProgramacionCuna) to $obj2 (VentaCuniaComercial)
				$obj2->addProgramacionCuna($obj1);
	...
	/**
	 * Selects a collection of ProgramacionCuna objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ProgramacionCunaPeer::addSelectColumns($criteria);
		$startcol2 = (ProgramacionCunaPeer::NUM_COLUMNS - ProgramacionCunaPeer::NUM_LAZY_LOAD_COLUMNS);

		VentaCuniaComercialPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (VentaCuniaComercialPeer::NUM_COLUMNS - VentaCuniaComercialPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined VentaCuniaComercial rows

			$key2 = VentaCuniaComercialPeer::getPrimaryKeyHashFromRow($row, $startcol2);
			if ($key2 !== null) {
				$obj2 = VentaCuniaComercialPeer::getInstanceFromPool($key2);
				if (!$obj2) {
				...
				// Add the $obj1 (ProgramacionCuna) to the collection in $obj2 (VentaCuniaComercial)
				$obj2->addProgramacionCuna($obj1);
