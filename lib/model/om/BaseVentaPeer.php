...
abstract class BaseVentaPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codigo', 'Usuario', 'Precio', 'FechaVenta', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('codigo', 'usuario', 'precio', 'fechaVenta', ),
		BasePeer::TYPE_COLNAME => array (self::CODIGO, self::USUARIO, self::PRECIO, self::FECHA_VENTA, ),
		BasePeer::TYPE_FIELDNAME => array ('codigo', 'usuario', 'precio', 'fecha_venta', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codigo' => 0, 'Usuario' => 1, 'Precio' => 2, 'FechaVenta' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('codigo' => 0, 'usuario' => 1, 'precio' => 2, 'fechaVenta' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::CODIGO => 0, self::USUARIO => 1, self::PRECIO => 2, self::FECHA_VENTA => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('codigo' => 0, 'usuario' => 1, 'precio' => 2, 'fecha_venta' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		$criteria->addSelectColumn(VentaPeer::CODIGO);
		$criteria->addSelectColumn(VentaPeer::USUARIO);
		$criteria->addSelectColumn(VentaPeer::PRECIO);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseVentaPeer', $criteria, $con);
		}
	...
	public static function doCountJoinUsuarioRelatedByUsuario(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VentaPeer::USUARIO, UsuarioPeer::CODIGO, $join_behavior);
	...
	{
		return $withPrefix ? VentaPeer::CLASS_DEFAULT : VentaPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseVentaPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseVentaPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(VentaPeer::CODIGO) && $criteria->keyContainsValue(VentaPeer::CODIGO) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.VentaPeer::CODIGO.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseVentaPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseVentaPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseVentaPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseVentaPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(VentaPeer::CODIGO);
			$selectCriteria->add(VentaPeer::CODIGO, $criteria->remove(VentaPeer::CODIGO), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseVentaPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseVentaPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(VentaPeer::CODIGO, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(VentaPeer::CODIGO, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(VentaPeer::DATABASE_NAME);
			$criteria->add(VentaPeer::CODIGO, $pks, Criteria::IN);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseVentaPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
