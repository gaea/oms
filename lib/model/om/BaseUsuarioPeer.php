...
abstract class BaseUsuarioPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codigo', 'Usuario', 'Contrasena', 'Habilitado', 'Perfil', 'Persona', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('codigo', 'usuario', 'contrasena', 'habilitado', 'perfil', 'persona', ),
		BasePeer::TYPE_COLNAME => array (self::CODIGO, self::USUARIO, self::CONTRASENA, self::HABILITADO, self::PERFIL, self::PERSONA, ),
		BasePeer::TYPE_FIELDNAME => array ('codigo', 'usuario', 'contrasena', 'habilitado', 'perfil', 'persona', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codigo' => 0, 'Usuario' => 1, 'Contrasena' => 2, 'Habilitado' => 3, 'Perfil' => 4, 'Persona' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('codigo' => 0, 'usuario' => 1, 'contrasena' => 2, 'habilitado' => 3, 'perfil' => 4, 'persona' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::CODIGO => 0, self::USUARIO => 1, self::CONTRASENA => 2, self::HABILITADO => 3, self::PERFIL => 4, self::PERSONA => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('codigo' => 0, 'usuario' => 1, 'contrasena' => 2, 'habilitado' => 3, 'perfil' => 4, 'persona' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
