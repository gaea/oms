...
abstract class BaseUsuarioPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codigo', 'Usuario', 'Contrasena', 'Perfil', 'Persona', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('codigo', 'usuario', 'contrasena', 'perfil', 'persona', ),
		BasePeer::TYPE_COLNAME => array (self::CODIGO, self::USUARIO, self::CONTRASENA, self::PERFIL, self::PERSONA, ),
		BasePeer::TYPE_FIELDNAME => array ('codigo', 'usuario', 'contrasena', 'perfil', 'persona', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codigo' => 0, 'Usuario' => 1, 'Contrasena' => 2, 'Perfil' => 3, 'Persona' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('codigo' => 0, 'usuario' => 1, 'contrasena' => 2, 'perfil' => 3, 'persona' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::CODIGO => 0, self::USUARIO => 1, self::CONTRASENA => 2, self::PERFIL => 3, self::PERSONA => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('codigo' => 0, 'usuario' => 1, 'contrasena' => 2, 'perfil' => 3, 'persona' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
