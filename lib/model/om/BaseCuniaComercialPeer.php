...
abstract class BaseCuniaComercialPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codigo', 'Nombre', 'Duracion', 'Url', 'Habilitada', 'FechaCreacion', 'Usuario', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('codigo', 'nombre', 'duracion', 'url', 'habilitada', 'fechaCreacion', 'usuario', ),
		BasePeer::TYPE_COLNAME => array (self::CODIGO, self::NOMBRE, self::DURACION, self::URL, self::HABILITADA, self::FECHA_CREACION, self::USUARIO, ),
		BasePeer::TYPE_FIELDNAME => array ('codigo', 'nombre', 'duracion', 'url', 'habilitada', 'fecha_creacion', 'usuario', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codigo' => 0, 'Nombre' => 1, 'Duracion' => 2, 'Url' => 3, 'Habilitada' => 4, 'FechaCreacion' => 5, 'Usuario' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('codigo' => 0, 'nombre' => 1, 'duracion' => 2, 'url' => 3, 'habilitada' => 4, 'fechaCreacion' => 5, 'usuario' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::CODIGO => 0, self::NOMBRE => 1, self::DURACION => 2, self::URL => 3, self::HABILITADA => 4, self::FECHA_CREACION => 5, self::USUARIO => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('codigo' => 0, 'nombre' => 1, 'duracion' => 2, 'url' => 3, 'habilitada' => 4, 'fecha_creacion' => 5, 'usuario' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
