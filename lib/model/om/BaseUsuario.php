...
abstract class BaseUsuario extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = UsuarioPeer::NUM_COLUMNS - UsuarioPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Usuario has previously been saved, it will retrieve
	 * related Personas from storage. If this Usuario is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collPersonas === null) {
			if ($this->isNew()) {
			   $this->collPersonas = array();
				...
				$criteria->add(PersonaPeer::USUARIO, $this->codigo);
	 ...
	 */
	public function getPersonasJoinTipoIdentificacionRelatedByTipoIdentificacion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UsuarioPeer::DATABASE_NAME);
		}
		...
		if ($this->collPersonas === null) {
			if ($this->isNew()) {
				...
				$this->collPersonas = PersonaPeer::doSelectJoinTipoIdentificacionRelatedByTipoIdentificacion($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
