...
abstract class BaseUsuario extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->habilitado = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->perfil = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->persona = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->resetModified();
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getHabilitado(),
			$keys[4] => $this->getPerfil(),
			$keys[5] => $this->getPersona(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setHabilitado($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setPerfil($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setPersona($arr[$keys[5]]);
	}
