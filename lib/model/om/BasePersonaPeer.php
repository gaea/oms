...
abstract class BasePersonaPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codigo', 'Nombre', 'Apellido', 'Identificacion', 'TipoIdentificacion', 'Direccion', 'Telefono', 'EMail', 'Habilitado', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('codigo', 'nombre', 'apellido', 'identificacion', 'tipoIdentificacion', 'direccion', 'telefono', 'eMail', 'habilitado', ),
		BasePeer::TYPE_COLNAME => array (self::CODIGO, self::NOMBRE, self::APELLIDO, self::IDENTIFICACION, self::TIPO_IDENTIFICACION, self::DIRECCION, self::TELEFONO, self::E_MAIL, self::HABILITADO, ),
		BasePeer::TYPE_FIELDNAME => array ('codigo', 'nombre', 'apellido', 'identificacion', 'tipo_identificacion', 'direccion', 'telefono', 'e_mail', 'habilitado', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codigo' => 0, 'Nombre' => 1, 'Apellido' => 2, 'Identificacion' => 3, 'TipoIdentificacion' => 4, 'Direccion' => 5, 'Telefono' => 6, 'EMail' => 7, 'Habilitado' => 8, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('codigo' => 0, 'nombre' => 1, 'apellido' => 2, 'identificacion' => 3, 'tipoIdentificacion' => 4, 'direccion' => 5, 'telefono' => 6, 'eMail' => 7, 'habilitado' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::CODIGO => 0, self::NOMBRE => 1, self::APELLIDO => 2, self::IDENTIFICACION => 3, self::TIPO_IDENTIFICACION => 4, self::DIRECCION => 5, self::TELEFONO => 6, self::E_MAIL => 7, self::HABILITADO => 8, ),
		BasePeer::TYPE_FIELDNAME => array ('codigo' => 0, 'nombre' => 1, 'apellido' => 2, 'identificacion' => 3, 'tipo_identificacion' => 4, 'direccion' => 5, 'telefono' => 6, 'e_mail' => 7, 'habilitado' => 8, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
	);
