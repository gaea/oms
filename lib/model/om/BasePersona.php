...
abstract class BasePersona extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the tipo_identificacion field.
	 * @var        int
	 */
	 ...
	 */
	protected $aTipoIdentificacionRelatedByTipoIdentificacion;
	...
	/**
	 * Get the [tipo_identificacion] column value.
	 * 
	 * @return     int
	 */
	...
	public function setCodigo($v)
	{
		...
		if ($this->codigo !== $v) {
			$this->codigo = $v;
			$this->modifiedColumns[] = PersonaPeer::CODIGO;
		}
	...
	/**
	 * Set the value of [tipo_identificacion] column.
	 * 
	 * @param      int $v new value
	 * @return     Persona The current object (for fluent API support)
	 */
	public function setTipoIdentificacion($v)
	{
		...
		if ($this->tipo_identificacion !== $v) {
			$this->tipo_identificacion = $v;
			$this->modifiedColumns[] = PersonaPeer::TIPO_IDENTIFICACION;
		}

		if ($this->aTipoIdentificacionRelatedByTipoIdentificacion !== null && $this->aTipoIdentificacionRelatedByTipoIdentificacion->getCodigo() !== $v) {
			$this->aTipoIdentificacionRelatedByTipoIdentificacion = null;
		}
	...
	public function setHabilitado($v)
	{
		...
		if ($this->habilitado !== $v) {
			$this->habilitado = $v;
			$this->modifiedColumns[] = PersonaPeer::HABILITADO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->identificacion = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->tipo_identificacion = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			...
			$this->e_mail = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aTipoIdentificacionRelatedByTipoIdentificacion !== null && $this->tipo_identificacion !== $this->aTipoIdentificacionRelatedByTipoIdentificacion->getCodigo()) {
			$this->aTipoIdentificacionRelatedByTipoIdentificacion = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aTipoIdentificacionRelatedByTipoIdentificacion !== null) {
				if ($this->aTipoIdentificacionRelatedByTipoIdentificacion->isModified() || $this->aTipoIdentificacionRelatedByTipoIdentificacion->isNew()) {
					$affectedRows += $this->aTipoIdentificacionRelatedByTipoIdentificacion->save($con);
				}
				$this->setTipoIdentificacionRelatedByTipoIdentificacion($this->aTipoIdentificacionRelatedByTipoIdentificacion);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aTipoIdentificacionRelatedByTipoIdentificacion !== null) {
				if (!$this->aTipoIdentificacionRelatedByTipoIdentificacion->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aTipoIdentificacionRelatedByTipoIdentificacion->getValidationFailures());
				}
			}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getIdentificacion(),
			$keys[4] => $this->getTipoIdentificacion(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				$this->setTipoIdentificacion($value);
				break;
			case 5:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setIdentificacion($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setTipoIdentificacion($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PersonaPeer::CODIGO)) $criteria->add(PersonaPeer::CODIGO, $this->codigo);
		...
		if ($this->isColumnModified(PersonaPeer::TIPO_IDENTIFICACION)) $criteria->add(PersonaPeer::TIPO_IDENTIFICACION, $this->tipo_identificacion);
		...
		if ($this->isColumnModified(PersonaPeer::HABILITADO)) $criteria->add(PersonaPeer::HABILITADO, $this->habilitado);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PersonaPeer::CODIGO, $this->codigo);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTipoIdentificacion($this->tipo_identificacion);
	 ...
	 * @throws     PropelException
	 */
	public function setTipoIdentificacionRelatedByTipoIdentificacion(TipoIdentificacion $v = null)
	{
		if ($v === null) {
			$this->setTipoIdentificacion(NULL);
		} else {
			$this->setTipoIdentificacion($v->getCodigo());
		}

		$this->aTipoIdentificacionRelatedByTipoIdentificacion = $v;
	 ...
	 * @throws     PropelException
	 */
	public function getTipoIdentificacionRelatedByTipoIdentificacion(PropelPDO $con = null)
	{
		if ($this->aTipoIdentificacionRelatedByTipoIdentificacion === null && ($this->tipo_identificacion !== null)) {
			$this->aTipoIdentificacionRelatedByTipoIdentificacion = TipoIdentificacionPeer::retrieveByPk($this->tipo_identificacion);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aTipoIdentificacionRelatedByTipoIdentificacion->addPersonas($this);
			 */
		}
		return $this->aTipoIdentificacionRelatedByTipoIdentificacion;
	}
	 ...
	 * related Usuarios from storage. If this Persona is new, it will return
		...
		if ($this->collUsuarios === null) {
			if ($this->isNew()) {
			   $this->collUsuarios = array();
				...
				$criteria->add(UsuarioPeer::PERSONA, $this->codigo);
	...
	public function addUsuario(Usuario $l)
	{
		...
		if (!in_array($l, $this->collUsuarios, true)) { // only add it if the **same** object is not already associated
			...
			$l->setPersonaRelatedByPersona($this);
		}
	}
	 ...
	 */
	public function getUsuariosJoinPerfilRelatedByPerfil($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PersonaPeer::DATABASE_NAME);
		}
		...
		if ($this->collUsuarios === null) {
			if ($this->isNew()) {
				...
				$this->collUsuarios = UsuarioPeer::doSelectJoinPerfilRelatedByPerfil($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
