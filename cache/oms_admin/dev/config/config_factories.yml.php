...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/oms/log/oms_admin_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/oms/cache/oms_admin/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/oms/apps/oms_admin/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/oms/cache/oms_admin/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/oms/apps/oms_admin/template',
)));
